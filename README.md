...
18 роутеров (Cisco IOL) и 7 свитчей (IOU L2) в 7 автономных системах. Документ содержит полный адресный план, краткое описание автоматизации и итоги по домашке.
